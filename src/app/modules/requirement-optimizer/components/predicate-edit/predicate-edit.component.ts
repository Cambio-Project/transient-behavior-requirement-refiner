...
import { LogicOperator, LOGIC_OPERATOR_OPTIONS } from '../../../../shared/enums/logic-operator';
...
export class PredicateEditComponent implements OnInit {
	...
	predicateForm: FormGroup = new FormGroup({
		...
		fLogicOperator: new FormControl(null, [Validators.required]),
		fComparisonValue: new FormControl(null, [Validators.required]),
	});
